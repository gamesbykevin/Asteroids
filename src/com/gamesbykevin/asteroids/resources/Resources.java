...
public class Resources implements IResources
{
    ...
    public Resources() throws Exception
    {
        ...
        fonts = new HashMap<>();
        fonts.put(TypeFont.GameFont, new GameFont());
        fonts.put(TypeFont.MenuFont, new MenuFont());
    ...
    {
        return this.fonts.get(TypeFont.GameFont).get(key);
    }
    
    public Font getMenuFont(final Object key)
    {
        return this.fonts.get(TypeFont.MenuFont).get(key);
    }
